...
var numero = 10; // let numero = 20; Erro! no se puede declarar 2 let con el mmismo nombre 
//Caracteristica #2
...
console.log(saludo()); //console.log(nombre); //nombre is not defined, no se puede acceder a la variable dentro de la funcion
//Caracteristica #3
...
console.log(serAdulto); //Caracteristica #4
// const se usas cuando queremos que el valor de una variable no cambie

var apellido = "Angel"; // No se puede cambiar el valor de la constante apellido 
// apellido = 'Gonzalez'
